## Now that you have an overview of TCP/IP protocol suite, we're going to take a closer look at communications protocols on the network layer. The Internet protocol (IP) is the single most common of all.
